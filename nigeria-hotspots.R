## Hot spots for Nigeria - for website
## Date: January 2024
...
data <- read.csv("data/nigeria.csv")

# not possible to calculate hotspots for 2009
data <- data %>%
  filter(
    event_relevant >= 1 &
      year > 2009
...
st_write(
  result_df.sf,
  "visualisation-data/nigeria-hotspots/nigeria-hotspots.shp"
)
